...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public static int mDefaultPanelHeight = 0;
     ...
     */
    public static final int DEFAULT_PANEL_HEIGHT = 68; // dp;
    ...
    /**
     * Flag indicating if the panel view is showing or is slided out
     */
    private boolean mIsSlidedOut = false;
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDefaultPanelHeight = mPanelHeight;
    ...
    public void slideOutPanel(boolean animated) {
        if(animated){
            setPanelHeight(-20);
            if(mSlideableView != null) {
                mDragHelper.smoothSlideViewTo(mSlideableView, 0, getHeight());
            }
    ...
    public void slideInPanel(boolean animated, int height) {
        if(animated) {
            setPanelHeight(height);
            if(mSlideableView != null) {
                mDragHelper.smoothSlideViewTo(mSlideableView, 0, getHeight() - height);
            }
            ViewCompat.postInvalidateOnAnimation(this);
        } else {
            setPanelHeight(height);
